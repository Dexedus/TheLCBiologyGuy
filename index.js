      ...
      lineItems.data.forEach(item => {
        ...
        if (products[0] === 'Cell & Ecology Free Masterclasses (March 6th and 9th)') {
          ...
          productTable = 'testtable';
            ...
            message = `Hey ${firstName},<br><br>The Halloween Masterclasses will run on the 27th and 28th of October.<br><br>Classes will start at [Time] on both days.<br><br>Both classes will be recorded and uploaded to this Google Drive: [Insert link]<br><br>The Zoom link will be shared on the 26th of October.<br><br>Best,<br>Max<br><br><b>If you'd like to opt-out of future promotional emails, please click <a href="https://www.thelcbiologyguy.ie/#opt" target="_blank">Here</a> and submit your email address. Thanks!<b/>`;
